const btnstyle = { display: "flex", height: "25px", marginTop: "5px", fontSize: "20px", textAlign: "center", justifyContent: "center", backgroundColor: "#E5F3FA" };
...
const btnequal = { height: "45px", marginTop: "5px", fontSize: "20px", textAlign: "center", justifyContent: "center", backgroundColor: "#F4E6FA" };
...
class Calculator extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("button", { id: "decimal", onClick: this.dec, style: btnstyle }, "."), /*#__PURE__*/
      React.createElement("button", { id: "add", onClick: this.sum, style: btnstyle }, "+"), /*#__PURE__*/
      React.createElement("button", { id: "subtract", onClick: this.sub, style: btnstyle }, "-"), /*#__PURE__*/
      React.createElement("button", { id: "divide", onClick: this.div, style: btnstyle }, "/"), /*#__PURE__*/
      React.createElement("button", { id: "multiply", onClick: this.multi, style: btnstyle }, "*"), /*#__PURE__*/
      React.createElement("button", { id: "equals", onClick: this.eq, style: btnequal }, "="))));
